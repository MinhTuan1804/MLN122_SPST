    ...
    <div className="fixed inset-0 bg-[#0C0907]/90 flex items-center justify-center p-4 z-50 animate-fade-in backdrop-blur-sm select-none">
      <div className="w-full max-w-sm bg-[#1C1814] woodcut-border p-6 rounded-xl shadow-2xl relative space-y-5">
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              <span className="text-xs md:text-sm font-sans font-medium text-paper-aged/95">
                Đồ Họa Conflict Scene 3D
              </span>
              <span className="text-[10px] text-paper-aged/50">
                Tắt để tăng hiệu năng (dùng fallback 2D)
              </span>
            </div>
            <button
              onClick={toggle3D}
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-paper-aged/50">
                Hiện phân rã công thức & thuật ngữ Các Mác
              </span>
            </div>
            <button
          ...
          <div className="flex flex-col gap-1 border-t border-leather-brown/10 pt-3">
            <div className="flex justify-between items-center">
              ...
              <span className="text-[9px] text-paper-aged/40">
                Hội thoại Cố vấn
              </span>
            </div>
            <input
        ...
        <div className="p-3 bg-[#15110E] rounded border border-leather-brown/10 text-[10px] text-paper-aged/60 leading-relaxed font-sans text-left">
          <p className="font-semibold text-brass-polished mb-1">
            Cơ chế kinh tế & công thức:
          </p>
          <p className="mb-0.5">
            • W = c + v + m (Giá trị hàng hóa dệt = tư bản bất biến + tư bản khả
            biến + thặng dư)
          </p>
          <p className="mb-0.5">
            • m' = m / v * 100% (Tỷ suất giá trị thặng dư / Mức độ khai thác lao
            động)
          </p>
          <p>
            • oc = c / v (Cấu tạo hữu cơ tư bản. oc tăng tức là sa thải bớt nhân
            công)
          </p>
        </div>
        ...
        <div className="pt-3 border-t border-leather-brown/10 space-y-2">
          <span className="text-[10px] uppercase font-mono tracking-wider text-paper-aged/50 block text-left">
            Xem thử Video Kết Cục
          </span>
